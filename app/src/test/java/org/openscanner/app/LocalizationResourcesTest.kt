...
class LocalizationResourcesTest {
    ...
    fun semanticWifiLabelsAreTranslatedIntoSimplifiedChinese() {
        val expected = mapOf(
            ...
            "common_yes" to "是",
            "common_no" to "否",
            "settings_language_label" to "应用语言",
            "settings_language_system_default" to "系统默认",
            "settings_language_english" to "English",
            "settings_language_simplified_chinese" to "简体中文",
